...
export default function TableSixInput({dateToday, user}) {
  ...
  const [puntajeTotalSix, setPuntajeTotalSix] = React.useState({
    totalSix: 0,
  })
...
React.useEffect(() => {
  ...
  const puntajeSampleSix = (Number(inputSample.sampleSixVista) + Number(inputSample.sampleSixNariz)*3
  + Number(inputSample.sampleSixBoca)*4 + Number(inputSample.sampleSixEquil)*2)
  ...
  setPuntajeTotalSix({totalSix: puntajeSampleSix})
}, [inputSample])
...
const dataSend = {
  ...
  muestraNameF : resData[0].sampleSix,
  bodegaF : resData[0].bodegaSeis,
  origenF : resData[0].origenSeis,
  precioF : resData[0].precioSeis,
  muestraPositionF : positionF,
...
const addPunctuation = async () => {
  ...
  if (
      ...
      inputSample.sampleFiveVista !== '' && inputSample.sampleFiveEquil !== '' && inputSample.sampleSixBoca !== '' && 
      inputSample.sampleSixNariz !== '' && inputSample.sampleSixVista !== '' && inputSample.sampleSixEquil !== ''
    ) {
  ...
  React.useEffect(() => {    
    ...
    setPositionF(calcularNumeros(puntajeTotalSix.totalSix));
  }, [puntajeTotalOne, puntajeTotalTwo, puntajeTotalThree, puntajeTotalFour, puntajeTotalFive, puntajeTotalSix, puntajeCalcular])
    ...
    <h2 className="mb-3">DEGUSTACIÓN N°: {resData[0].eventNumber}</h2><table class="table">
      <thead>
        <tr>
          ...
          <th scope="col" className="text-center">B</th>
          <th scope="col" className="text-center">C</th>
          <th scope="col" className="text-center">D</th>
          <th scope="col" className="text-center">E</th>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <input type="number" required className="w-75 text-center" name="sampleOneVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleTwoVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleThreeVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFourVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFiveVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleSixVista" onChange={handleInputChange}/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
            <input type="number" required className="w-75 text-center" name="sampleOneNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleTwoNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleThreeNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFourNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFiveNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleSixNariz" onChange={handleInputChange}/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
            <input type="number" required className="w-75 text-center" name="sampleOneBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleTwoBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleThreeBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFourBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFiveBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleSixBoca" onChange={handleInputChange}/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
            <input type="number" required className="w-75 text-center" name="sampleOneEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleTwoEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleThreeEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFourEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleFiveEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" required className="w-75 text-center" name="sampleSixEquil" onChange={handleInputChange}/>
          </td>
        </tr>
        <br /><br />
        <tr>
          {/* <th style={{background: '#94618E', borderRadius: 50, color: 'white', textAlign: 'center' }} scope="row">Puntaje</th> */}
          <th scope="row"></th>
          <td>
            <p className="ms-1 ms-lg-3" style={{ fontWeight: 'bold', fontSize: 20, color: '#C5BBCD' }}>{puntajeTotalOne.totalOne}</p>
          </td>
          <td>
            <p className="ms-1 ms-lg-3" style={{ fontWeight: 'bold', fontSize: 20, color: '#C5BBCD' }}>{puntajeTotalTwo.totalTwo}</p>
          </td>
          <td>
            <p className="ms-1 ms-lg-3" style={{ fontWeight: 'bold', fontSize: 20, color: '#C5BBCD' }}>{puntajeTotalThree.totalThree}</p>
          </td>
          <td>
            <p className="ms-1 ms-lg-3" style={{ fontWeight: 'bold', fontSize: 20, color: '#C5BBCD' }}>{puntajeTotalFour.totalFour}</p>
          </td>
          <td>
            <p className="ms-1 ms-lg-3" style={{ fontWeight: 'bold', fontSize: 20, color: '#C5BBCD' }}>{puntajeTotalFive.totalFive}</p>
          </td>
          <td>
            <p className="ms-1 ms-lg-3" style={{ fontWeight: 'bold', fontSize: 20, color: '#C5BBCD' }}>{puntajeTotalSix.totalSix}</p>
          </td>
        </tr>
        <br />
        <tr>
          ...
          <td>
            <p className="ms-3" style={{ fontWeight: 'bold', fontSize: 20 }}>{positionF}</p>
          </td>
        </tr>
      </tbody>
    </table>
