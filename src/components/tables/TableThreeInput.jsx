...
export default function TableThreeInput({dateToday, user}) {
...
const handleInputChange = (event) => {
  ...
  const puntajeCalcular = [puntajeTotalOne.totalOne, puntajeTotalTwo.totalTwo, puntajeTotalThree.totalThree]
  ...
  }, [puntajeTotalOne, puntajeTotalTwo, puntajeTotalThree, puntajeCalcular])
    ...
    <h2 className="mb-3">DEGUSTACIÓN N°: {resData[0].eventNumber}</h2><table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <input type="number" className="w-50 text-center" name="sampleOneVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleTwoVista" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleThreeVista" onChange={handleInputChange}/>
          </td>
        </tr>
        <tr>
         <th scope="row">
          ...
          <td>
            <input type="number" className="w-50 text-center" name="sampleOneNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleTwoNariz" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleThreeNariz" onChange={handleInputChange}/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
            <input type="number" className="w-50 text-center" name="sampleOneBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleTwoBoca" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleThreeBoca" onChange={handleInputChange}/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td>
            <input type="number" className="w-50 text-center" name="sampleOneEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleTwoEquil" onChange={handleInputChange}/>
          </td>
          <td>
            <input type="number" className="w-50 text-center" name="sampleThreeEquil" onChange={handleInputChange}/>
          </td>
        </tr>
        <br /><br />
        <tr>
