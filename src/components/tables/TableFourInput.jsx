...
export default function TableFourInput({dateToday, user}) {
...
const addPunctuation = async () => {
  ...
  }, [puntajeTotalOne, puntajeTotalTwo, puntajeTotalThree, puntajeTotalFour, puntajeCalcular])
  ...
  return resData?.length ? (
    ...
    <h2 className="mb-3">DEGUSTACIÓN N°: {resData[0].eventNumber}</h2><table class="table">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">
            <img src={boca} alt="" style={{ width: 30, height: 30 }}/>
          </th>
          <td>
